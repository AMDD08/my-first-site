...
export function Projects() {
  ...
  const defaultInfo = {
    title: "Projects",
    subtitle: "THE FIRST CHAPTER: SHOBAR",
    initialDisplay: 6,
    loadMoreCount: 3,
    background: {"image":"","video":"","color":"","opacity":0.1},
    projects: [{"image":"/uploads/project-0-1757192586527.png","video":"","title":"SHOBAR (쇼바): 도심 속 충격 정비소","description":"자동차/오토바이의 ‘쇼바(Shock Absorber)’에서 영감을 얻은 도심 속 충격 정비소.\n‘우리도 흔들린다. 하지만 우리만의 방식으로 중심을 잡는다’는 철학 아래, 혼자여도 괜찮고 함께여도 자유로운 특별한 순간을 설계하는 F&B 브랜드입니다. 현재 성북동에서 첫 번째 공간 런칭을 준비 중입니다."},{"image":"/uploads/project-1-1757192596162.png","video":"","title":"Coming soon!","description":"😝"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
