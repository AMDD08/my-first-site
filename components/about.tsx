...
export function About() {
  ...
  const defaultInfo = {
    ...
    subtitle: "결과로 증명해 온 경험의 기록",
    background: {"image":"","video":"","color":"","opacity":0.1},
    experienceCards: [{"icon":"briefcase","title":"[교대역 조그마한 고깃집] 매출성장 전략(Turnaround & Growth)","period":"2023-2024","description":"월 매출 2천만원대 매장을 약 3개월 만에 3천 9백만원으로 성장시킨 운영총괄경험"},{"icon":"graduation","title":"[건대 TOP 이자카야] 포기하지 않는 근성 및 실행력","period":"2024-현재","description":"요리경험 '0', 부족했던 시작을 넘어, 포기하지 않는 근성으로 1년 만에 주방 총괄 과장으로 성장. 현재 모든 동료에게 그 실행력을 인정받고 있음."},{"icon":"award","title":"기획 및 결과 창출 능력 (Planning & Outcome)","period":"2014-2015","description":"3개 분야 프로젝트 기획 및 수상. 분야를 가리지 않고 아이디어를 성공적인 결과물로 만드는 능력 검증"},{"icon":"lightbulb","title":"신규 브랜드 기획 (New Brand Development)","period":"2025-현재","description":"F&B 브랜드 '쇼바(SHOBAR)' 기획. 서울시 지원사업 최종 계획서 제출 완료"}],
    skills: [{"icon":"trophy","title":"리더십 및 팀 빌딩","description":"명확한 목표 설정과 동기부여를 통해, 팀의 시너지를 극대화하고 최상의 결과를 만들어냅니다."},{"icon":"target","title":"브랜드 컨셉 기획","description":"공간의 특성과 시장 트렌드를 결합하여, 누구도 따라 할 수 없는 독창적인 브랜드 스토리를 설계합니다."},{"icon":"brain","title":"데이터 기반 운영","description":"단순한 감이 아닌, KPI와 데이터에 근거하여 매출 성장과 고객 만족이라는 두 마리 토끼를 모두 잡습니다."},{"icon":"server","title":"커뮤니티 빌딩 및 로컬 브랜딩","description":"사람과 공간, 스토리를 연결하여 팬덤을 구축하고, 지역의 가치를 높이는 로컬 브랜드를 기획하고 실행합니다."},{"icon":"edit","title":"콘텐츠 기획 및 스토리텔링","description":"평범한 이야기 속에서 특별함을 발견하고, 사람들의 마음에 울림을 주는 매력적인 콘텐츠로 재창조합니다."},{"icon":"globe","title":"경험 설계 (Experience Design, XD)","description":"고객의 시간과 감정을 고려하여, 온라인과 오프라인을 넘나드는 총체적인 경험의 여정을 설계하고 구현합니다."}],
    storyTitle: "My story",
    story: ["저는 평범한 하루의 순간들이 모여 한 사람의 특별한 이야기가 된다고 믿습니다. 그래서 저는 사람들의 일상에 잊히지 않을 특별한 장면을 더하는 '경험 설계자'입니다.","음식을 만들고 공간을 운영하며, 단순히 메뉴를 파는 것이 아니라 손님의 시간을 기획하고 분위기를 설계하는 법을 배웠습니다. 매출이 하락하던 공간에 새로운 활력을 불어넣는 과정은, 결국 사람들의 발길을 다시 이끄는 '경험의 힘'을 증명하는 시간이었습니다.\n","이제 저는 이 '경험의 힘'을 바탕으로, 저만의 이야기를 시작하려 합니다. 그 첫 번째 챕터는 도시인의 지친 하루를 위로하는 F&B 브랜드 ‘쇼바(SHOBAR)’입니다. 쇼바를 시작으로, 저는 공간과 브랜드, 그리고 콘텐츠라는 도구를 넘나들며 사람들의 평범한 하루를 특별한 이야기로 만드는 도전을 계속해 나갈 것입니다."],
    storyImage: "/uploads/about-image-1757192494848.jpeg",
    hobbies: ["📚 독서 및 글쓰기","🎨 문화/예술활동","🏃 러닝/크로스핏/MMA","🍳 요리","🎸 악기 연주(드럼/피아노/기타)","📸 사진"]
  }
...
>
      ...
      {showHobbyModal && isEditMode && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[2147483647]">
          <div className="bg-background border rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold">INSPIRATIONS 편집</h3>
              <button
