...
export function Hero() {
  ...
  const defaultInfo = {
    greeting: "평범한 하루가 모여",
    name: "특별한 하루를 만듭니다.",
    title: "때론 무심하게 흘려보내고, 때론 온전히 몰입하는 모든 순간들. 그 하루들이 모여 당신의 이야기가 되도록, 잊히지 않을 경험을 설계하는 사람, 이진우입니다.",
    description: "이진우 (리데이) | Founder, Experience Designer 함께 만들고 싶은 하루가 있다면, 당신의 이야기를 들려주세요.",
    profileImage: "/uploads/hero-profile-1757192155881.png",
    background: {"image":"/uploads/hero-background-1757192164556.png","video":"","color":"","opacity":0.1},
